  ...
  <a name="top"></a>
	...
	<div class="content">
      ...
      <form action = "" method = "post" name = "myform" >
        ...
        <?php 
		$sql="SELECT question,A,B,C,D,answer FROM test WHERE chapter=5 && no=1";$query = mysql_query($sql);$row = mysql_fetch_array($query);
        ...
        <tr height=80px><td align="center">
        <?php 
		$sql="SELECT question,A,B,C,D,answer FROM test WHERE chapter=5 && no=2";$query = mysql_query($sql);$row = mysql_fetch_array($query);
        ...
        <tr height=80px><td align="center">
        <?php 
		$sql="SELECT question,A,B,C,D,answer FROM test WHERE chapter=5 && no=3";$query = mysql_query($sql);$row = mysql_fetch_array($query);
        ...
        <tr height=80px><td align="center">
        <?php 
		$sql="SELECT question,A,B,C,D,answer FROM test WHERE chapter=5 && no=4";$query = mysql_query($sql);$row = mysql_fetch_array($query);
        ...
        <tr height=80px><td align="center">
        <?php 
		$sql="SELECT question,A,B,C,D,answer FROM test WHERE chapter=5 && no=5";$query = mysql_query($sql);$row = mysql_fetch_array($query);
        ...
        <tr height=80px><td align="center">
        <?php 
		$sql="SELECT question,A,B,C,D,answer FROM test WHERE chapter=5 && no=6";$query = mysql_query($sql);$row = mysql_fetch_array($query);
        ...
        <tr height=80px><td align="center">
        <?php 
		$sql="SELECT question,A,B,C,D,answer FROM test WHERE chapter=5 && no=7";$query = mysql_query($sql);$row = mysql_fetch_array($query);
        ...
        <tr height=80px><td align="center">
        <?php 
		$sql="SELECT question,A,B,C,D,answer FROM test WHERE chapter=5 && no=8";$query = mysql_query($sql);$row = mysql_fetch_array($query);
        ...
        <?php 
		$sql="SELECT question,A,B,C,D,answer FROM test WHERE chapter=5 && no=9";$query = mysql_query($sql);$row = mysql_fetch_array($query);
        ...
        <?php 
		$sql="SELECT question,A,B,C,D,answer FROM test WHERE chapter=5 && no=10";$query = mysql_query($sql);$row = mysql_fetch_array($query);
...
if (isset($_POST['btnSubAns']))
{
	...
	$query = mysql_query("
	SELECT score FROM grade WHERE account = '$account' && chapter=5
	");
	...
	if ($score>$hscore)
	{
		$hscore=$score;
		mysql_query("
		UPDATE grade SET score='$hscore' WHERE account='$account' and chapter='5'
		");
	}
